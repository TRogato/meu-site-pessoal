...
// Destinatário
$para = "t.rogato@gmail.com";

// Assunto do e-mail
$assunto = "Contato do através do site https://trogato.github.io/meu-site-pessoal/";
...
if (!empty($nome) && !empty($email) && !empty($mensagem)) {
    ...
    echo "<script>alert('$msg');window.location.assign('https://trogato.github.io/meu-site-pessoal/contato.html');</script>";
} else {
